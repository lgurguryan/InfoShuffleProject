...
expName = 'RecogMem_V2'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/aussie-dzmac/Documents/InfoShuffleProject/RecogMem_W2026/RecogMem_V2.py',
