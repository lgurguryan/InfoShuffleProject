...
folder_path <- "/Users/laurigurguryan/Desktop/InfoShuffleProject/DATA_TemMemFullRando"
...
# Plot for the effect of pair type
...
ggplot(df_pairtype_acc, aes(x = pairType, y = mean_corr, fill = pairType)) +
  ...
  scale_x_discrete(labels = c(
    ...
    "across-boundary" = "across-boundary\n(blocked only)" ))+
  labs(
    title = "Accuracy by Pair Type",
    x = "Pair Type",
    y = "Proportion Correct") +
  theme_classic() +
  guides(fill = "none", color = "none")
