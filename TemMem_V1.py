...
expName = 'TemMem_V1'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/aussie-dzmac/Documents/InfoShuffleProject/TemMem_V1.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    BlockLoop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('blocks_V1.csv'), 
        seed=None, 
    )
