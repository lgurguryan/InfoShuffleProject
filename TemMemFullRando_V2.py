...
expName = 'TemMemFullRando_V2'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/aussie-dzmac/Documents/InfoShuffleProject/TemMem_W2026/TemMemFullRando_V2.py',
