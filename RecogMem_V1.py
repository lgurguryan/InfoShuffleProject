...
expName = 'RecogMem_V1'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/aussie-dzmac/Documents/InfoShuffleProject/RecogMem_W2026/RecogMem_V1.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    LearningInst2Text = visual.TextStim(win=win, name='LearningInst2Text',
        text='LEARNING PHASE \n\n\n\nTo help you remember, we encourage you to link the images together by making up a story that connects them in the order you see them. \n\nFor example, if you see an APPLE, then a CHAIR, then a PEN, you could imagine yourself eating an apple while sitting on a chair and writing a letter with the pen...\n\n\n\nPress SPACEBAR to continue',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    TestInstText = visual.TextStim(win=win, name='TestInstText',
        text='TEST PHASE\n\nYou will be presented with pairs of images. \n\nOne image will be OLD, meaning that you saw it during the Learning Phase. The other image will be NEW, meaning that you have not seen it before. \n\nYour task will be to indicate which image is the OLD image. \n\nYou will have a maximum of 8 seconds to make your response before the screen advances. \n\nPress 5 to practice',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    TestExampleRightImage = visual.ImageStim(
        ...
        image='redumbrella.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0.3, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    conditionsFile = os.path.join(
        '/Users',
        'aussie-dzmac',
        'Documents/InfoShuffleProject/RecogMem_W2026/SubjectFiles_RecogMemFullRando',
        expInfo['participant'],
        'blocks_V1_recog.csv'
    )
    ...
    TestReminderText = visual.TextStim(win=win, name='TestReminderText',
        text='TEST PHASE\n\n\n\nYour task will be to indicate which image you think is OLD (i.e., you saw it during the Learning Phase). \n\nYou will have a miximum of 8 seconds to make your response before the screen advances. \n\n\n\nPress 5 to begin',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
